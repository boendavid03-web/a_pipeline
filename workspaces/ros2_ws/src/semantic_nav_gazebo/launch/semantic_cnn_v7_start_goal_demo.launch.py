...
# 推荐运行方式：ros2 launch semantic_nav_gazebo semantic_cnn_v7_start_goal_demo.launch.py
...
# 【绝对依赖关系】
# 文件绝对路径：/home/user/navigation_project/a_pipeline/workspaces/ros2_ws/src/semantic_nav_gazebo/launch/semantic_cnn_v7_start_goal_demo.launch.py
...
# 【脚本说明｜semantic_cnn_v7_start_goal_demo.launch.py】
...
"""Launch the v7 Gazebo start/goal SemanticCNN demo."""
...
def generate_launch_description():
    ...
    default_model_code = str(project_root / "methods" / "baselines" / "semantic_cnn" / "training" / "scripts")
    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                name="semantic_cnn_actual_trajectory",
                output="screen",
                parameters=[
                    {
                        "use_sim_time": ParameterValue(LaunchConfiguration("use_sim_time"), value_type=bool),
            ...
            TimerAction(
                ...
                actions=[
                    ...
                    Node(
                        package="semantic_nav_gazebo",
                        executable="semantic_cnn_v7_inference_node.py",
                        name="semantic_cnn_v7_inference",
                        output="screen",
                        parameters=[
                            {
                                "use_sim_time": ParameterValue(LaunchConfiguration("use_sim_time"), value_type=bool),
                                ...
                                "model": LaunchConfiguration("semantic_cnn_model"),
                                "model_code": LaunchConfiguration("semantic_cnn_model_code"),
